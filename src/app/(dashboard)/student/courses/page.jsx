...
export default async function Courses() {
  ...
  // async function signinCourse(formData) {
  //   "use server";
  //   const res = await fetch(`http://127.0.0.1:5002/api/sign`, {
  //     method: "POST",
  //     headers: {
  //       "Content-Type": "application/json",
  ...
  // const data = await getCoursesList(session.user.token);
  console.log(data[0]);
