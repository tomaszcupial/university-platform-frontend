...
const navigation = [
  ...
  { name: "Kursy", href: "/lecturer/courses", icon: FolderIcon },
];
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    {status === "authenticated" ? (
                      ...
                      <div className="h-8 w-8 rounded-full bg-lime-200 flex justify-center items-center text-lime-700 font-bold"></div>
                    )}
